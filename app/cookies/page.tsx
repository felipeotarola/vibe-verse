    ...
    <main className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-950 text-white">
      <div className="container px-4 py-8 mx-auto">
        ...
        <div className="prose prose-invert max-w-none">
          <p>
            This Cookie Policy explains how VibeVerse by Copernic uses cookies and similar technologies to recognize you
            when you visit our website and apps.
          </p>
          ...
          <h2>6. What if I Don't Want Cookies?</h2>
          <p>
            If you'd prefer to restrict, block, or delete cookies from our site, you can use your browser to do this.
            Each browser is different, so check the 'Help' menu of your particular browser to learn how to change your
            cookie preferences.
          </p>
          ...
          <h2>8. Contact Us</h2>
          <p>If you have any questions about this Cookie Policy, please contact us at privacy@copernic.dev.</p>
        </div>
      </div>
    </main>
  )
