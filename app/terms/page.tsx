    ...
    <main className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-950 text-white">
      <div className="container px-4 py-8 mx-auto">
        <header className="mb-8">
          ...
          <p className="mt-2 text-gray-300">Last updated: April 1, 2025</p>
        </header>

        <div className="prose prose-invert max-w-none">
          <p>
            Welcome to VibeVerse by Copernic. These Terms of Service ("Terms") govern your use of our website, apps, and
            services.
          </p>
          ...
          <p>
            Our Privacy Policy describes how we handle the information you provide to us when you use our services. By
            using our services, you agree to our data practices as described in our Privacy Policy.
          </p>
          ...
          <p>
            ...
            publish, and display such content.
          </p>

          <h2>6. Prohibited Conduct</h2>
          <p>You agree not to misuse our services or help anyone else do so. For example, you must not:</p>
          <ul>
          ...
          <h2>7. Termination</h2>
          <p>
            We may suspend or terminate your access to our services at any time for any reason without notice or
            liability.
          </p>
          ...
          <p>If you have any questions about these Terms, please contact us at legal@copernic.dev.</p>
        </div>
      </div>
    </main>
  )
